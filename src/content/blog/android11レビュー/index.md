...
容量が1.02GBあるのでストレージには気をつけたほうがいい。

ちなみに学校のバス乗る直前に更新始めたらJR山陽本線(赤穂線直通)播州赤穂行きの岡山駅発車してしばらくしたら完了した。
...
電源を長押したときの画面がこうなってました。

デバイスコントロールというのはまた後で別の使い方として登場しますが主にGoogleHomeや自宅のエアコンや電気をスマホと連携していたら使える機能です。

## う～んと思ったこと

音楽再生時の画面の通知領域が変わったのはそうなんですが。
...
<iframe allowfullscreen height="266" src="https://www.youtube.com/embed/JkH842V9_jc" width="320" youtube-src-=""></iframe>

一応録音できてるかできてないかなので上手い下手は気にしないでください。

## 通知の変更

Android11は主立っているのは通知です。
...
こいつにもあります隠し機能イースターエッグ

設定→デバイス情報→Androidバージョン→Androidバージョンを連打！！

したら時計のようなやつを適当にぐるぐる回してたら11が出て下に猫が出てきます。

猫といえばAndroid NougatにありましたAndroid Nekoです。
...
デバイスの追加の設定にすると例のデバイスコントロールの画面にこの画面が出ます。

水を入れたり、餌を上げたりしてあげてください。

猫が現れます。

そして新機能であるバブルなんかも体験できたりするようですね。(友達もさほど多くない人にもおすすめ！！)
